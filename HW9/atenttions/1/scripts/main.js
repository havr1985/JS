...
for (const course of coursesArray) {
    ...
    const monthDurationBlock = document.createElement('p');
    monthDurationBlock.textContent = `Month duration - ${course.monthDuration}`
    container.appendChild(monthDurationBlock);

    const hourDurationBlock = document.createElement('p');
    hourDurationBlock.textContent = ` Hours duration - ${course.hourDuration}`
    container.appendChild(hourDurationBlock);
